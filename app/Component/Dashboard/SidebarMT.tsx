...
<div
  ...
  <div>
    ...
    <div className='w-full'>
      <a href="/user/CreateTransaction" className='group flex items-center gap-[10px] px-4 py-2 flex-wrap'>
        ...
        <span className='text-[#2f2b3dad] text-[15px] group-hover:text-[#1988db]'>Buat Trasaksi</span>
      </a>
      ...
      <a href="/user/MyTransaction"
        className='group flex items-center gap-[10px] px-4 py-2 flex-wrap rounded-[6px] bg-gradient-to-r from-[#1988db_22.6%] to-[rgba(25,136,219,0.7)_76.47%]'>
        <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
        </svg>
        <span className='text-white text-[15px]'>Transaksi Saya</span>
      </a>
